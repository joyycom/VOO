...
extern "C" {
	 ...
	 */
	VN2_Result VN2_Gesture_Create( VN2Handle * handle, const int argc, const void * argv[] );

	/*
	 # VN2_Gesture_Destory
	 # - handle: handle of Gesture context
	 */
	VN2_Result VN2_Gesture_Destory( VN2Handle * handle );
	 ...
	 */
	VN2_Result VN2_Gesture_Apply_CPU( VN2Handle handle, const void * input, void * output );
	 ...
	 */
	VN2_Result VN2_Gesture_Apply_GPU( VN2Handle handle, const void * input, void * output );
	 ...
	 */
	VN2_Result VN2_Gesture_Set_Attr( VN2Handle handle, const char * name, const void * value );
	 ...
	 */
	VN2_Result VN2_Gesture_Get_Attr( VN2Handle handle, const char * name, void * value );
