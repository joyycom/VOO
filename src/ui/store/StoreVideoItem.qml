...
Item {
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onReleased: {
                ...
                if (!isMove) {
                    ...
                    videoLocalList.selectIndex = index
                }
                if (dragEnable()) {
                    ...
                    if (Logic.onReleased(
                                ...
                                selectCount > 0 ? videoLocalList.selectList : [index])) {
                        videoLocalList.focus = false
                    }
                }
            }
        }
        StoreContainer {
            ...
            extension: fileUtils.isVideoExtension(
                           filePath) ? videoDuration : fileExtension(filePath)
        }
        Text {
            text: fileName
            width: parent.width
        ...
        Image {
            ...
            MouseArea {
                ...
                onClicked: {
                    videoLocalList.focus = false
                    datasource.addLocalVideoResource([index])
                }
            }
        }
    }
